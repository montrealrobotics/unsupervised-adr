...
class RandomizedResidualPushEnv(ResidualSlipperyPushEnv):
    ...
    def __init__(
        ...
        super(RandomizedResidualPushEnv, self).__init__(
    ...
    def _randomize_damping(self):
        damping = self.dimensions[0].current_value
    ...
    def _re_init(self, xml):
        ...
        randomized_path = os.path.join(self.xml_dir, "pusher.xml")
