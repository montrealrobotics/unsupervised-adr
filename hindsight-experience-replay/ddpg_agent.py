...
# change the replay_buffer code. Make it dynamic. Also look how you are appending the observartions etc during self play.
                        else:
                            with torch.no_grad():
                                input_tensor = self._preproc_inputs(obs, g)
                                pi = self.actor_network(input_tensor)
                ...
                # printing the shapes
                print(f'The Shape of mb_obs : {mb_obs.shape}') # The Shape of mb_obs : (10, 51, 10)
                print(f'The Shape of mb_g: {mb_g.shape}') # The Shape of mb_g: (10, 50, 3)
                print(f'The Shape of mb_ag : {mb_ag.shape}') # The Shape of mb_ag : (10, 51, 3)
                print(f'The Shape of mb_actions: {mb_actions.shape}') # The Shape of mb_actions: (10, 50, 4)
                # store the episodes
    ...
    def _update_normalizer(self, episode_batch):
        ...
        print(f'The shape of obs : {obs}')# The shape of obs : (50, 10)
        print(f'The shape of g : {g}') # The shape of g: (50, 3)
    ...
    def _update_network(self):
        ...
        print(f'The Shape of obs : {transitions["obs"].shape}') # The Shape of obs : (256, 10)
        print(f'The Shape of g: {transitions["g"].shape}') # The Shape of g: (256, 3)
        print(f'The Shape of ag : {transitions["ag"].shape}') # The Shape of ag : (256, 3)
        print(f'The Shape of actions: {transitions["actions"].shape}') # The Shape of actions: (256, 4)
